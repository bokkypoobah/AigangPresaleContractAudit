...
Source file [../../contracts/PreSaleWallet.sol](../../contracts/PreSaleWallet.sol).

**NOTE** Aigang have advised that they will not be using PreSaleWallet as this complicates the contract setup even
further. This contract will not be code reviewed or tested.
